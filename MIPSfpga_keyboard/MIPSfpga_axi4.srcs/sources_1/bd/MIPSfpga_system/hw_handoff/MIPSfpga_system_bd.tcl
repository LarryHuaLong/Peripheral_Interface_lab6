...
CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false} \
  ...
  connect_bd_net -net PS2Receiver_0_irq [get_bd_pins PS2Receiver_0/irq] [get_bd_pins xlconcat_0/In2]
