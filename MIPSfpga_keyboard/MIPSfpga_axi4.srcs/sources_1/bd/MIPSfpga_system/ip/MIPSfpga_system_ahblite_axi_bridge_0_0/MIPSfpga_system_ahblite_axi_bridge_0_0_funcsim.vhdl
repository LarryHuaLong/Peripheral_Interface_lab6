...
entity MIPSfpga_system_ahblite_axi_bridge_0_0_ahb_if is
  ...
  attribute ORIG_REF_NAME of MIPSfpga_system_ahblite_axi_bridge_0_0_ahb_if : entity is "ahb_if";
end MIPSfpga_system_ahblite_axi_bridge_0_0_ahb_if;

architecture STRUCTURE of MIPSfpga_system_ahblite_axi_bridge_0_0_ahb_if is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MIPSfpga_system_ahblite_axi_bridge_0_0_ahblite_axi_control is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of MIPSfpga_system_ahblite_axi_bridge_0_0_ahblite_axi_control : entity is "ahblite_axi_control";
end MIPSfpga_system_ahblite_axi_bridge_0_0_ahblite_axi_control;

architecture STRUCTURE of MIPSfpga_system_ahblite_axi_bridge_0_0_ahblite_axi_control is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MIPSfpga_system_ahblite_axi_bridge_0_0_axi_rchannel is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of MIPSfpga_system_ahblite_axi_bridge_0_0_axi_rchannel : entity is "axi_rchannel";
end MIPSfpga_system_ahblite_axi_bridge_0_0_axi_rchannel;

architecture STRUCTURE of MIPSfpga_system_ahblite_axi_bridge_0_0_axi_rchannel is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f : entity is "counter_f";
end MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f;

architecture STRUCTURE of MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f_0 is
  port (
    Q : out STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f_0 : entity is "counter_f";
end MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f_0;

architecture STRUCTURE of MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f__parameterized0\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f__parameterized0\ : entity is "counter_f";
end \MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f__parameterized0\;

architecture STRUCTURE of \MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f__parameterized0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MIPSfpga_system_ahblite_axi_bridge_0_0_ahb_data_counter is
  port (
    Q : out STD_LOGIC_VECTOR ( 4 downto 0 );
    ahb_penult_beat_reg : out STD_LOGIC;
    s_ahb_htrans : in STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of MIPSfpga_system_ahblite_axi_bridge_0_0_ahb_data_counter : entity is "ahb_data_counter";
end MIPSfpga_system_ahblite_axi_bridge_0_0_ahb_data_counter;

architecture STRUCTURE of MIPSfpga_system_ahblite_axi_bridge_0_0_ahb_data_counter is
begin
AHB_SAMPLE_CNT_MODULE: entity work.MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f_0
     port map (
      E(0) => E(0),
      Q(4 downto 0) => Q(4 downto 0),
      SR(0) => SR(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MIPSfpga_system_ahblite_axi_bridge_0_0_axi_wchannel is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of MIPSfpga_system_ahblite_axi_bridge_0_0_axi_wchannel : entity is "axi_wchannel";
end MIPSfpga_system_ahblite_axi_bridge_0_0_axi_wchannel;

architecture STRUCTURE of MIPSfpga_system_ahblite_axi_bridge_0_0_axi_wchannel is
...
AXI_WRITE_CNT_MODULE: entity work.MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f
     port map (
      D(0) => D(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MIPSfpga_system_ahblite_axi_bridge_0_0_time_out is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of MIPSfpga_system_ahblite_axi_bridge_0_0_time_out : entity is "time_out";
end MIPSfpga_system_ahblite_axi_bridge_0_0_time_out;

architecture STRUCTURE of MIPSfpga_system_ahblite_axi_bridge_0_0_time_out is
...
begin
  ...
  timeout_o <= \^timeout_o\;
\GEN_WDT.WDT_COUNTER_MODULE\: entity work.\MIPSfpga_system_ahblite_axi_bridge_0_0_counter_f__parameterized0\
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MIPSfpga_system_ahblite_axi_bridge_0_0_ahblite_axi_bridge is
  port (
    m_axi_wvalid : out STD_LOGIC;
    m_axi_wlast : out STD_LOGIC;
    s_ahb_hrdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of MIPSfpga_system_ahblite_axi_bridge_0_0_ahblite_axi_bridge : entity is "ahblite_axi_bridge";
end MIPSfpga_system_ahblite_axi_bridge_0_0_ahblite_axi_bridge;

architecture STRUCTURE of MIPSfpga_system_ahblite_axi_bridge_0_0_ahblite_axi_bridge is
...
AHBLITE_AXI_CONTROL: entity work.MIPSfpga_system_ahblite_axi_bridge_0_0_ahblite_axi_control
     port map (
      AXI_ALEN_i0 => AXI_ALEN_i0,
...
AHB_DATA_COUNTER: entity work.MIPSfpga_system_ahblite_axi_bridge_0_0_ahb_data_counter
     port map (
      E(0) => AHB_IF_n_33,
...
AHB_IF: entity work.MIPSfpga_system_ahblite_axi_bridge_0_0_ahb_if
     port map (
      AXI_ALEN_i0 => AXI_ALEN_i0,
...
AXI_RCHANNEL: entity work.MIPSfpga_system_ahblite_axi_bridge_0_0_axi_rchannel
     port map (
...
AXI_WCHANNEL: entity work.MIPSfpga_system_ahblite_axi_bridge_0_0_axi_wchannel
     port map (
      D(0) => AHBLITE_AXI_CONTROL_n_4,
...
TIME_OUT: entity work.MIPSfpga_system_ahblite_axi_bridge_0_0_time_out
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity MIPSfpga_system_ahblite_axi_bridge_0_0 is
  port (
    s_ahb_hclk : in STD_LOGIC;
    s_ahb_hresetn : in STD_LOGIC;
    s_ahb_hsel : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of MIPSfpga_system_ahblite_axi_bridge_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of MIPSfpga_system_ahblite_axi_bridge_0_0 : entity is "MIPSfpga_system_ahblite_axi_bridge_0_0,ahblite_axi_bridge,{}";
  attribute core_generation_info : string;
  attribute core_generation_info of MIPSfpga_system_ahblite_axi_bridge_0_0 : entity is "MIPSfpga_system_ahblite_axi_bridge_0_0,ahblite_axi_bridge,{x_ipProduct=Vivado 2015.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=ahblite_axi_bridge,x_ipVersion=3.0,x_ipCoreRevision=3,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=artix7,C_INSTANCE=MIPSfpga_system_ahblite_axi_bridge_0_0,C_M_AXI_SUPPORTS_NARROW_BURST=0,C_M_AXI_NON_SECURE=1,C_S_AHB_ADDR_WIDTH=32,C_M_AXI_ADDR_WIDTH=32,C_S_AHB_DATA_WIDTH=32,C_M_AXI_DATA_WIDTH=32,C_M_AXI_PROTOCOL=AXI4,C_M_AXI_THREAD_ID_WIDTH=4,C_AHB_AXI_TIMEOUT=256}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of MIPSfpga_system_ahblite_axi_bridge_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of MIPSfpga_system_ahblite_axi_bridge_0_0 : entity is "ahblite_axi_bridge,Vivado 2015.2";
end MIPSfpga_system_ahblite_axi_bridge_0_0;

architecture STRUCTURE of MIPSfpga_system_ahblite_axi_bridge_0_0 is
...
U0: entity work.MIPSfpga_system_ahblite_axi_bridge_0_0_ahblite_axi_bridge
     port map (
      m_axi_araddr(31 downto 0) => \^m_axi_araddr\(31 downto 0),
      m_axi_arburst(1 downto 0) => \^m_axi_arburst\(1 downto 0),
      m_axi_arcache(1 downto 0) => \^m_axi_arcache\(1 downto 0),
